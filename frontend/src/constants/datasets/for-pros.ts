...
export const data = {
  banner: {
    title: 'Κάνε Επαγγελματικό Λογαριασμό στη Doulitsa',
    description:
      'Προσφέρεις υπηρεσίες; Βρες νέους πελάτες και ανάπτυξε την επιχείρησή σου με την Doulitsa.',
    titleClassName: 'text-2xl md:text-3xl md:leading-[1.15]',
  ...
  cta: {
    ...
    description:
      'Δημιούργησε το επαγγελματικό σου προφίλ δωρεάν και άρχισε να βρίσκεις νέους πελάτες σήμερα.',
    button: {
      text: 'Εγγραφή Επαγγελματικού Λογαριασμού',
      link: '/register#pro',
    },
  },
  hero: {
  ...
  featuresGrid: {
    ...
    image: '/ok-sign-emilia.webp',
    alt: 'Ικανοποιημένη επαγγελματίας της Doulitsa',
    list: [
      {
  ...
  faq: {
    ...
    list: [
      ...
      {
        id: 'Six',
        question: 'Χρειάζεται να πληρώσω για να ξεκινήσω;',
        answer:
          'Όχι. Μπορείς να δημιουργήσεις επαγγελματικό προφίλ και να δημοσιεύσεις υπηρεσίες εντελώς δωρεάν με το Βασικό πακέτο. Το Προωθημένο είναι προαιρετική αναβάθμιση για μεγαλύτερη προβολή.',
        isOpen: false,
      },
      {
        id: 'Seven',
        question: 'Ποια είναι η διαφορά ανάμεσα στο Βασικό και το Προωθημένο πακέτο;',
        answer:
          'Το Βασικό πακέτο είναι δωρεάν και περιλαμβάνει έως 3 υπηρεσίες με βασική ορατότητα. Το Προωθημένο σου δίνει έως 15 υπηρεσίες, αυτόματη καθημερινή ανανέωση, έως 3 προωθημένες υπηρεσίες, προβολή στην κορυφή του επαγγελματικού καταλόγου και μεγαλύτερη προβολή συνολικά.',
        isOpen: false,
      },
      {
        id: 'Eight',
        question: 'Μπορώ να ακυρώσω το Προωθημένο πακέτο όποτε θέλω;',
        answer:
          'Ναι. Μπορείς να ακυρώσεις όποτε θέλεις από το Ταμπλό → Συνδρομή. Διατηρείς τις δυνατότητες του Προωθημένου μέχρι το τέλος της περιόδου που έχεις ήδη πληρώσει και έπειτα επιστρέφεις αυτόματα στο Βασικό πακέτο.',
        isOpen: false,
      },
    ],
  },
