...
COLUMNS = {
    "chats": ["createdAt", "updatedAt", "lastActivity"],
    "chat_members": ["joinedAt", "lastSeen"],
    "messages": ["createdAt", "updatedAt", "deletedAt", "editedAt"],
    "blocked_users": ["createdAt", "updatedAt"],
    "email_batches": ["createdAt", "updatedAt", "sentAt"],
}
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("messaging", "0002_emailbatch_messageids_arrayfield"),
    ]
