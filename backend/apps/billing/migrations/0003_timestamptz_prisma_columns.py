...
COLUMNS = {
    "subscriptions": ["currentPeriodStart", "currentPeriodEnd", "canceledAt", "createdAt", "updatedAt", "firstPaymentAt", "lastPaymentAt"],
    "subscription_payment_attempts": ["createdAt"],
}
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("billing", "0002_subscriptionpaymentattempt"),
    ]
