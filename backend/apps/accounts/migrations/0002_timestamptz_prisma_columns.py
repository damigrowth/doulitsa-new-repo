...
COLUMNS = {
    "users": ["createdAt", "updatedAt", "banExpires", "lastUnreadEmailSentAt", "lastUsernameChangeAt"],
    "accounts": ["createdAt", "updatedAt", "access_token_expires_at", "refresh_token_expires_at"],
    "sessions": ["expiresAt", "createdAt", "updatedAt"],
    "verification": ["expiresAt", "createdAt", "updatedAt"],
    "pending_registrations": ["createdAt", "expiresAt"],
    "jwks": ["createdAt"],
}
